...
public class MakeMytrip1 {
	...
	@Test
	public void bookTikect() throws InterruptedException {
	...
	driver.findElement(By.xpath("input//[@placeholder='From' and @autocomplete='off']")).sendKeys("hjd");
	// driver.findElement(By.xpath("//input[@id='fromCity']")).sendKeys("k");*/
		...
		//Set the web driver manager to chrome
				...
				//navigate to desired date in calender0
				Thread.sleep(1000);
